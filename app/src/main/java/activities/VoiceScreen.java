...
import fragments.SMS_Overall;
import fragments.SMS_Specific;
import fragments.VoiceOverall;
import fragments.VoiceSpecific;
import util.AndroidUtil;
import util.ObjectSerializer;
import util.ViewPagerAdapter;

public class VoiceScreen extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    private SharedPreferences.Editor editor;
    private ViewPager viewPager;
    private AndroidUtil util;
    private AlertDialog.Builder builder;
    private ViewPagerAdapter adapter;
    private VoiceOverall fragmentOne;
    private VoiceSpecific fragmentTwo;
    private SharedPreferences prefs;
    public static VoiceScreen instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        util = new AndroidUtil(VoiceScreen.this);
        if (!util.isOnline()) {
    ...
    public static VoiceScreen getInstance() {
        return instance;
    }
    ...
    private void setupViewPager() {
        ...
        fragmentOne = new VoiceOverall();
        fragmentTwo = new VoiceSpecific();
        adapter.addFragment(fragmentOne, "Voice Overall");
        adapter.addFragment(fragmentTwo, "Voice Specific");
        setViewPageAdapter();
    }
    ...
    public FragmentRefreshListener_voice getFragmentRefreshListener() {
        return fragmentRefreshListener;
    }

    public void setFragmentRefreshListener(FragmentRefreshListener_voice fragmentRefreshListener) {
        this.fragmentRefreshListener = fragmentRefreshListener;
    }

    private FragmentRefreshListener_voice fragmentRefreshListener;

    public interface FragmentRefreshListener_voice{
        void onRefresh();
    }
