...
public class SMSScreen extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private SMS_Overall fragmentOne;
    private SMS_Specific fragmentTwo;
    private SharedPreferences prefs;
    public static SMSScreen instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        util = new AndroidUtil(SMSScreen.this);
        if (!util.isOnline()) {
    ...
    public static SMSScreen getInstance() {
        return instance;
    }
    ...
    private void setupViewPager() {
        ...
        fragmentOne = new SMS_Overall();
        fragmentTwo = new SMS_Specific();
        adapter.addFragment(fragmentOne, "SMS Overall");
        adapter.addFragment(fragmentTwo, "SMS Specific");
        setViewPageAdapter();
    }
    ...
    public FragmentRefreshListener_sms getFragmentRefreshListener() {
        return fragmentRefreshListener;
    }

    public void setFragmentRefreshListener(FragmentRefreshListener_sms fragmentRefreshListener) {
        this.fragmentRefreshListener = fragmentRefreshListener;
    }

    private FragmentRefreshListener_sms fragmentRefreshListener;

    public interface FragmentRefreshListener_sms{
        void onRefresh();
    }
