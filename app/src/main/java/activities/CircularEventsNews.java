...
import fragments.CircularFrag;
import fragments.EventsFrag;
import fragments.NewsFrag;
import util.AndroidUtil;
import util.ObjectSerializer;
import util.ViewPagerAdapter;

public class CircularEventsNews extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private CircularFrag fragmentOne;
    private EventsFrag fragmentTwo;
    private NewsFrag fragmentThree;
    private SharedPreferences prefs;
    public static CircularEventsNews instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.circular_events_news);
        ...
        util = new AndroidUtil(CircularEventsNews.this);
        if (!util.isOnline()) {
    ...
    public static CircularEventsNews getInstance() {
        return instance;
    }
    ...
    private void setupViewPager() {
        ...
        fragmentOne = new CircularFrag();
        fragmentTwo = new EventsFrag();
        fragmentThree = new NewsFrag();
        adapter.addFragment(fragmentOne, "Circular");
        adapter.addFragment(fragmentTwo, "Events");
        adapter.addFragment(fragmentThree, "News");
        setViewPageAdapter();
    }
    ...
    public void onBackPressed() {
        ...
        CircularEventsNews.this.finish();
    }

    public FragmentRefreshListener_cir getFragmentRefreshListener() {
        return fragmentRefreshListener;
    }

    public void setFragmentRefreshListener(FragmentRefreshListener_cir fragmentRefreshListener) {
        this.fragmentRefreshListener = fragmentRefreshListener;
    }

    private FragmentRefreshListener_cir fragmentRefreshListener;

    public interface FragmentRefreshListener_cir{
        void onRefresh();
    }
