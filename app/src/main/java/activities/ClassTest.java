...
import fragments.ClassTestPast;
import fragments.ClassTestToday;
...
public class ClassTest extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private ClassTestToday fragmentOne;
    private ClassTestPast fragmentTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        util = new AndroidUtil(ClassTest.this);
        if (!util.isOnline()) {
    ...
    private void setupViewPager() {
        ...
        fragmentOne = new ClassTestToday();
        fragmentTwo = new ClassTestPast();
        adapter.addFragment(fragmentOne, "Today Class Test");
        adapter.addFragment(fragmentTwo, "Past Class Test");
        setViewPageAdapter();
    }
    ...
    public FragmentRefreshListener_classtest getFragmentRefreshListener() {
        return fragmentRefreshListener;
    }

    public void setFragmentRefreshListener(FragmentRefreshListener_classtest fragmentRefreshListener) {
        this.fragmentRefreshListener = fragmentRefreshListener;
    }

    private FragmentRefreshListener_classtest fragmentRefreshListener;

    public interface FragmentRefreshListener_classtest{
        void onRefresh();
    }
