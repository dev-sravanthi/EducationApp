...
import fragments.AttendanceMonthWise;
import fragments.AttendanceOverall;
...
public class Attendance extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private AttendanceOverall fragmentOne;
    private AttendanceMonthWise fragmentTwo;
    private SharedPreferences prefs;
    public static Attendance instance;
    private TabLayout allTabs;
    public String s4,s5,s6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        util = new AndroidUtil(Attendance.this);
        if (!util.isOnline()) {
    ...
    private void setupViewPager() {
        ...
        fragmentOne = new AttendanceOverall();
        fragmentTwo = new AttendanceMonthWise();
        adapter.addFragment(fragmentOne, "Attendance Overall");
        adapter.addFragment(fragmentTwo, "Attendance Monthwise");
        setViewPageAdapter();
    }
    ...
    public FragmentRefreshListener_att getFragmentRefreshListener() {
        return fragmentRefreshListener;
    }

    public void setFragmentRefreshListener(FragmentRefreshListener_att fragmentRefreshListener) {
        this.fragmentRefreshListener = fragmentRefreshListener;
    }

    private FragmentRefreshListener_att fragmentRefreshListener;

    public interface FragmentRefreshListener_att{
        void onRefresh();
    }
