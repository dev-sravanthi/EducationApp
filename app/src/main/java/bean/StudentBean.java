...
public class StudentBean {
    ...
    @SerializedName("data")
    @Expose
    private List<StudentDataBean> studentDataBeanList;
    ...
    public List<StudentDataBean> getStudentDataBeanList() {
        return studentDataBeanList;
    }

    public void setStudentDataBeanList(List<StudentDataBean> studentDataBeanList) {
        this.studentDataBeanList = studentDataBeanList;
    }

   public class StudentDataBean{
        private String academic_student_id,student_id,student_name,standard_section,code,gender,dob,doj,phone,emis_no,
                nationality,mother_tongue,blood_group,medium_of_study,community,caste,sub_caste,student_type,
