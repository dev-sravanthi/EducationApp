...
public class CircularFrag extends Fragment {

    private String date,description,title,attach_url;
    private List<CircularBean> list=new ArrayList<>();
...
//                Toast.makeText(getActivity(), "refreshed", Toast.LENGTH_SHORT).show();
    ...
    private void initViews(){
        ...
        circularAdapter = new CircularAdapter(list);
    ...
    private void loadJSON() {
        showBar();
        Call<CircularFragBean> call= RetrofitClient.getInstance().getApi().getCircularData("Bearer "+token,sibling_id);
            ...
            public void onResponse(Call<CircularFragBean> call, Response<CircularFragBean> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    for (int i=0;i<circularDataBeanslist.size();i++){
                        ...
                        CircularBean circularBean=new CircularBean(date,title,description,attach_url);
    ...
    public class CircularAdapter extends RecyclerView.Adapter<CircularAdapter.ViewHolder> {
        private List<CircularBean> circularBeans;
        Context context;
        ...
        public CircularAdapter(List<CircularBean> mlist)
        {
            this.circularBeans = mlist;
        ...
        public CircularAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new CircularAdapter.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(CircularAdapter.ViewHolder holder, int position) {
            CircularBean data = circularBeans.get(position);
...
//                        .into(holder.imageView);
    ...
    public class CircularBean {
        ...
        public CircularBean(String date,String title,String description,String attach_url){
            this.date=date;
            this.title=title;
