...
public class ClassTestPast extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.classtest_past, container, false);
...
//                Toast.makeText(getActivity(), "refreshed", Toast.LENGTH_SHORT).show();
    ...
    private void loadJSON() {
        showBar();
        Call<ClassTestTodayBean> call = RetrofitClient.getInstance().getApi().getClassTestPast("Bearer "+token,sibling_id);
    ...
    public class ChildCTTodayAdapter extends RecyclerView.Adapter<ChildCTTodayAdapter.ChildViewHolder> {
        ...
        @NonNull
        @Override
        public ChildCTTodayAdapter.ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.child_recyview_classtest_today,
                    viewGroup, false);
            return new ChildCTTodayAdapter.ChildViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull ChildCTTodayAdapter.ChildViewHolder holder, int position) {
