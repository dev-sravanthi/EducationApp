...
//                Toast.makeText(getActivity(), "refreshed", Toast.LENGTH_SHORT).show();
    ...
    private void loadJSON() {
        showBar();
        Call<CircularFragBean> call= RetrofitClient.getInstance().getApi().getNewsData("Bearer "+token,sibling_id);
            ...
            public void onResponse(Call<CircularFragBean> call, Response<CircularFragBean> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    for (int i=0;i<circularDataBeanslist.size();i++){
                        ...
                        NewsBean circularBean=new NewsBean(date,title,description,attach_url);
    ...
    public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(NewsAdapter.ViewHolder holder, int position) {
            NewsBean data = newsBeans.get(position);
...
//                        .into(holder.imageView);
    ...
    public class NewsBean {
        ...
        public NewsBean(String date,String title,String description,String attach_url){
            this.date=date;
            this.title=title;
